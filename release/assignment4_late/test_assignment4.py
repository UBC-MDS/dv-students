...
def test_1_2(answer):
    ...
    assert answer.encoding.y['shorthand'] == 'count()', "Make sure you are plotting the count on the y-axis."
...
def test_1_6(answer):
    ...
    assert answer.spec.encoding.x['shorthand'].repeat == 'repeat', "Make sure you are using the 'repeat' argument."
    assert answer.spec.encoding.y['shorthand'] == 'count()', "Make sure you are plotting the count on the Y-axis."
...
def test_2_1(answer):
    ...
    assert answer.spec.encoding.x['shorthand'].repeat == 'column', "Make sure you are using the 'repeat' argument on the columns."
...
def test_2_2(answer):
    assert not answer is None, "Your answer does not exist. Have you passed in the correct variable?"
    assert answer.spec.mark == 'circle', "Make sure you are creating a scatter plot using the 'mark_circle()' function."
    assert answer.spec.encoding.x['shorthand'].repeat == 'column', "Make sure you are passing the columns to the repeat argument."
    assert answer.spec.encoding.y['shorthand'].repeat == 'row', "Make sure you are passing the rows to the repeat argument."
...
def test_2_7(answer):
    ...
    assert answer.spec.encoding.x['scale']['zero'] == False, "Make sure you are using the 'alt.Scale(zero=False)' for the x axis."
    assert answer.spec.encoding.y['scale']['zero'] == False, "Make sure you are using the 'alt.Scale(zero=False)' for the y axis."
    assert answer.spec.encoding.color['shorthand'] == 'count()', "Make sure you are encoding the color channel to count."
    assert answer.spec.height == 120, "Make sure you are setting a height of 120."
    assert answer.spec.width == 120, "Make sure you are setting a width of 120."
    assert answer.config.axis.labels == False, "Make sure you are removing the axis labels."
    return(success)
...
def test_4_2(answer):
    ...
    assert answer.encoding.color['shorthand'] == 'count()', "Make sure you are coloring by the count aggregate."
...
def test_4_3(answer):
    ...
    assert answer.encoding.color['shorthand'] == 'count()', "Make sure you are coloring by the count aggregate."
    assert answer.encoding.size['shorthand'] == 'count()', "Make sure you are setting the size by the count aggregate."
    assert answer.encoding.x['shorthand'] == 'genres' or answer.encoding.x['field'] == 'genres', "Make sure you are plotting 'genres' on the x-axis."
    assert answer.encoding.y['shorthand'] == 'studios' or answer.encoding.y['field'] == 'studios', "Make sure you are plotting 'studios' on the y-axis."
    return(success)
...
def test_4_10(answer):
    ...
    assert answer.encoding.size['shorthand'] == 'proportion', "Make sure you are setting the size by proportions."
    assert answer.encoding.color['shorthand'] == 'proportion', "Make sure you are coloring by proportions."
    assert answer.encoding.x['shorthand'] == 'genres' or answer.encoding.x['field'] == 'genres', "Make sure you are plotting 'genres' on the x-axis."
    assert answer.encoding.y['shorthand'] == 'studios' or answer.encoding.y['field'] == 'studios', "Make sure you are plotting 'studios' on the y-axis."
    return(success)
